...
def segment_polygon_intersect() -> None:
    ...
    assert segment_polygon_intersect(p, s1) == False
    assert segment_polygon_intersect(p, s2) == True
    assert segment_polygon_intersect(p, s3) == True
    assert segment_polygon_intersect(p, s4) == True